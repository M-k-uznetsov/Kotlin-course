    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            ...
            NavHost(navController= navController, startDestination = "MainScreen"){
                composable("MainScreen"){ MainScreen(navController,viewJsonFromCenterBank) }
                composable("UserRegionScreen"){UserRegionScreen(navController,viewJsonFromCenterBank)}
